...
class ApplicationController {
    ...
    fun getUserApplication(@PathVariable("idUser") idUser: Long, @PathVariable("idApplication") idApplication: Long): ResponseEntity<Application> {
    ...
    @PostMapping
    fun createApplication(@PathVariable("idUser") idUser: Long, @RequestBody application: Application): ResponseEntity<Void> {
